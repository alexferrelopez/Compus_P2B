...
void LcInit(char rows, char columns) {
 ...
 RowAct = ColumnAct = 0;
 (TRISAbits.TRISA7 = TRISCbits.TRISC5 = TRISCbits.TRISC4 = 0);
 for (i = 0; i < 2; i++) {
  Espera(Timer, 100);
...
void EscriuPrimeraOrdre(char ordre) {
 ...
 (TRISCbits.TRISC0 = TRISCbits.TRISC1 = TRISCbits.TRISC2 = TRISCbits.TRISC3 = 0); (LATAbits.LATA7 = 0); (LATCbits.LATC5 = 0);
 (LATCbits.LATC4 = 1); (LATCbits.LATC4 = 1);
